...
- 自检 **202 项**全过（新增额度计量 8 项、额度徽标渲染 12 项）。
- 真实账号：Ark plan = `agent-plan/personal/small`，5h `19.1137/2000`、weekly `19.1137/7000`、
  monthly `118.2357/20000`；DeepSeek `¥102.95`、智谱 `¥19.94` 仍走金额口径不受影响。
