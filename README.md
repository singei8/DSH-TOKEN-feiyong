...
node scripts/check.mjs   # 202 项自检：真起 HTTP 服务跑通记账、分时计价、收口、node:fs 落盘、多供应商余额、方舟额度、slot 注册、重入（不打真网络）
```
...
│  └─ check.mjs                 # 自检 202 项：真起 HTTP 服务跑通路由、记账、分时、node:fs 落盘、多供应商余额、方舟额度、slot
